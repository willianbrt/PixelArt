...
function _add_layer(options) {
  ...
  function renameLayer(e) {
    ...
    inpNameLayer.addEventListener("keypress", function(e) {
      if (e.keyCode == 13) inpNameLayer.blur();
    });
  }
  ctr++;
}
