...
PixelEditor::PixelEditor(unsigned int width, unsigned int height) : previewLayer("preview", width, height) {
    ...
    // tiles.emplace_back(new Frame(_width, _height));
...
void PixelEditor::renderScreen(){
    renderCanvas(screen, _length, getViewportWidth(), 0, 0);
}
void PixelEditor::renderCanvas(unsigned int* buffer, int length, int width, int x, int y){
    EM_ASM({
...
EMSCRIPTEN_BINDINGS(pixel_editor_module){
    ...
    // class_<PixelEditor, base<CompoundingTiles<Frame>>>("PixelEditor")
    // class_<PixelEditor>("PixelEditor")
    ...
    //     .function("move", &PixelEditor::move)
    //     .function("panning", &PixelEditor::panning)
    //     .function("zoomIn", &PixelEditor::zoomIn)
    //     .function("zoomOut", &PixelEditor::zoomOut)
    //     .function("getScale", &PixelEditor::getScale)
    //     .function("getMinScale", &PixelEditor::getMinScale)
    //     .function("getMaxScale", &PixelEditor::getMaxScale)
    //     .function("getPosition", &PixelEditor::getPosition)
    //     ;
    register_vector<Frame*>("VectorFrame");
    ...
    // .function("renderArea", &PixelEditor::renderArea)
    // .function("clear", &PixelEditor::clear)
    // .function("zoomIn", &PixelEditor::zoomIn)
    // .function("zoomOut", &PixelEditor::zoomOut)
    // .function("zoom", &PixelEditor::zoom)
    // .function("panning", &PixelEditor::panning)
    // .function("move", &PixelEditor::move)
    // .function("getCurrentWidth", &PixelEditor::getCurrentWidth)
    // .function("getCurrentHeight", &PixelEditor::getCurrentHeight)
    // .function("getInitialPosition", &PixelEditor::getInitialPosition)
    // .function("getViewportWidth", &PixelEditor::getViewportWidth)
    // .function("getViewportHeight", &PixelEditor::getViewportHeight)
    // .function("getScale", &PixelEditor::getScale)
    // .function("getMinScale", &PixelEditor::getMinScale)
    // .function("getMaxScale", &PixelEditor::getMaxScale)
    // .function("getPosition", &PixelEditor::getPosition)
    // .function("getPixel", static_cast<unsigned int (PixelEditor::*)(int)>(&PixelEditor::getPixel))
    // .function("getPixel", static_cast<unsigned int (PixelEditor::*)(int, int, int)>(&PixelEditor::getPixel))
    ;
};
