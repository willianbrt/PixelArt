...
function findWasmBinary() {
  ...
  return new URL('graphics.wasm', import.meta.url).href;
}
...
var ASM_CONSTS = {
  4320: () => { const canvas = Module.canvas; return canvas.clientWidth; },  
 4381: () => { const canvas = Module.canvas; return canvas.clientHeight; },  
 4443: ($0) => { console.log(($0 >>> 0).toString(16)); },  
 4485: ($0, $1, $2, $3, $4) => { const canvas = Module.canvas; const context = canvas.getContext("2d"); context.clearRect(0, 0, canvas.clientWidth, canvas.clientHeight); const ptr = $0; const length = $1; const width = $2; const x = $3; const y = $4; const buffer = new Uint8ClampedArray(Module.HEAPU8.buffer, ptr, length*4); console.log(ptr, length, x, y); console.log(buffer); const data = new ImageData(buffer, width); context.putImageData(data, x, y); }
};
