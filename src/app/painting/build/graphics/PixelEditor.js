...
function findWasmBinary() {
  ...
  return new URL("PixelEditor.wasm", import.meta.url).href;
}
...
// === Body ===
var ASM_CONSTS = {
  90156: () => Module.canvas.clientWidth,
  90194: () => Module.canvas.clientHeight,
  90233: ($0, $1, $2, $3, $4) => {
    ...
    context.clearRect(x, y, width, length / width);
